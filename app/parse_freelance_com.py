...
webdev_url = 'http://www.freelance.com/en/search/mission?filter.searchLanguageCode=EN&filter.location.country=&filter.location.region1=&filter.location.city=&filter.duration=ALL&missionStartDateYear=2016&missionStartDateMonth=12&selSkills%5B0%5D=181&query='
